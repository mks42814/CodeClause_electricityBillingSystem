...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter){
        super("Dashboard || Admin Panel");    //frame title
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("assets/adminpanel.jpg"));
        ...
        master.setForeground(Color.BLUE);
            ...
            ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("assets/addnew.png"));
            ...
            ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("assets/userdetails.png"));
            ...
            ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("assets/depositdetails.png"));
            ...
            ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("assets/genbill.png"));
        ...
        JMenu info = new JMenu("User");
        info.setForeground(Color.RED);
       
            JMenuItem updateinformation = new JMenuItem("Update Information");
            updateinformation.setFont(new Font("monospaced", Font.PLAIN, 12));
            updateinformation.setBackground(Color.WHITE);
            ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("assets/updateinfo.png"));
            ...
            ImageIcon icon6= new ImageIcon(ClassLoader.getSystemResource("assets/viewinfo.png"));
        ...
        user.setForeground(Color.BLUE);
            ...
            ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("assets/paybill.png"));
            ...
            ImageIcon icon8= new ImageIcon(ClassLoader.getSystemResource("assets/billdetails.png"));
        ...
        report.setForeground(Color.BLUE);
            ...
            ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("assets/paybill.png"));
        ...
        utility.setForeground(Color.BLUE);
            ...
            ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("assets/notepad.png"));
            ...
            ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("assets/calc.png"));
        ...
        mexit.setForeground(Color.RED);
            ...
            ImageIcon icon12 = new ImageIcon(ClassLoader.getSystemResource("assets/logout.png"));
        ...
        //to hide admin controls in customer view
